...
func (d *Driver) CreateVolume(req Request) error {
	...
	//check if the volume name is a 64 chars.
	//Since this might imply a random name generated by Docker.
	//This check prevents run-away volume creation in EBS
	if len([]rune(id)) == 64{
		return fmt.Errorf("Volume name 64 chars. Are you sure this is not a Docker generated volume name? Please change the name and try again.")
	}
